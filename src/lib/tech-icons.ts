...
const SLUG_BY_KEY: Record<string, string> = {
  ...
  pyspark: "apachespark",
  pandas: "pandas",
  datamodeling: "diagramsdotnet",
  starwarehousing: "snowflake",
  etlpipelines: "apacheairflow",
  powerbi: "powerbi",
  apachekafka: "apachekafka",
  datagovernance: "microsoftazure",
  azuredatafactory: "microsoftazure",
  azuredatabricks: "databricks",
  azuresynapse: "microsoftazure",
  azureeventhubs: "microsoftazure",
  githubactions: "githubactions",
  microsoftpurview: "microsoftazure",
  mysql: "mysql",
  ...
  "azure synapse analytics": "microsoftazure",
  "azure event hubs": "microsoftazure",
  "microsoft purview": "microsoftazure",
  "apache kafka": "apachekafka",
  "power bi": "powerbi",
  "etl pipelines": "apacheairflow",
  "data modelling": "diagramsdotnet",
