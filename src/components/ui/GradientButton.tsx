  ...
  const content = (
    <motion.span
      ...
      className={cn(
        base,
        variant === "primary" &&
          "bg-ink text-[var(--on-ink)] shadow-[6px_6px_0_0_var(--coral)] hover:opacity-90 hover:shadow-[4px_4px_0_0_var(--coral-dim)] hover:translate-x-0.5 hover:translate-y-0.5",
        variant === "secondary" &&
